...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const requestHost = forwardedHost ?? requestHeaders.get("host") ?? "arya.health";
  const safeHost = /^[a-z0-9.-]+(?::\d+)?$/i.test(requestHost) ? requestHost : "arya.health";
  ...
  return {
    ...
    openGraph: {
      ...
      description: "Meet Voia by Arya Health — multilingual care navigation by voice and chat.",
      type: "website",
      images: [{ url: imageUrl, width: 1200, height: 630, alt: "Voia by Arya Health" }],
    },
    twitter: {
